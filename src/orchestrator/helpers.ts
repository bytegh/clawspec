...
export function buildHelpText(): string {
  return [
    ...
    "- `/clawspec deattach` makes ordinary chat stop injecting or recording ClawSpec context. `/clawspec attach` restores it. `cs-deattach` and `cs-attach` do the same thing from chat.",
